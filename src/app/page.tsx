...
export default function Home() {
  ...
  return (
    <main className="font-sans">
      ...
      <section className="nda-section px-6 xs:px-8 sm:px-10 md:px-[8%] lg:px-[10%] py-16 xs:py-20 sm:py-24 relative overflow-hidden m-4 rounded-2xl">
        ...
        <div className="max-w-7xl mx-auto relative z-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 xs:gap-8">
            ...
            <div className="relative overflow-hidden rounded-xl group">
              <Image 
                src="https://pub-54a964da83ba4c1e83adcceece9d2d28.r2.dev/plane.jpg" 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <h4 className="text-lg font-semibold mb-1">Private Jet Experience</h4>
                <p className="text-sm text-gray-200">Experiență cu jet privat</p>
              </div>
            </div>
      ...
      <a 
        href="https://wa.me/?text=Salut!%20Sunt%20interesat%20de%20experiențele%20Privé%20Escapes.%20%7C%20Hello!%20I'm%20interested%20in%20Privé%20Escapes%20experiences."
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 group touch-manipulation"
        aria-label="Chat on WhatsApp"
      >
        <div className="bg-gradient-to-br from-[#25D366] to-[#128C7E] w-14 h-14 xs:w-16 xs:h-16 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 border-2 border-white/20 hover:border-white/40">
          <svg 
        ...
        {/* Tooltip */}
        <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-black/90 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
          Chat pe WhatsApp | WhatsApp Chat
