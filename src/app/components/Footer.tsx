    ...
    <>
      <footer className="nda-section text-center py-8 xs:py-10 sm:py-12 px-6 xs:px-8 text-gray-500 border-t text-xs xs:text-sm mt-10 xs:mt-12 relative overflow-hidden m-4 rounded-2xl">
        ...
        <div className="max-w-screen-xl mx-auto relative z-20">
          <p className="mb-2">&copy; 2025 Privé Escapes</p>
          <p className="text-[#D4AF37] font-medium">Your privacy, our signature.</p>
        </div>
      </footer>
      ...
      >
        <div className="bg-gradient-to-br from-green-500 to-green-600 w-14 h-14 xs:w-16 xs:h-16 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 border-2 border-green-500/40 hover:border-green-500/80 relative overflow-hidden">
          <svg 
        ...
        {/* Tooltip */}
        <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-card border border-theme text-theme-primary text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none shadow-lg">
